...
var libarchive = (function () {
    ...
    return (function (moduleArg) {
        ...
        var _archive_entry_atime = Module["_archive_entry_atime"] = function () { return (_archive_entry_atime = Module["_archive_entry_atime"] = Module["asm"]["H"]).apply(null, arguments); };
        var _archive_entry_birthtime = Module["_archive_entry_birthtime"] = function () { return (_archive_entry_birthtime = Module["_archive_entry_birthtime"] = Module["asm"]["I"]).apply(null, arguments); };
        var _archive_entry_ctime = Module["_archive_entry_ctime"] = function () { return (_archive_entry_ctime = Module["_archive_entry_ctime"] = Module["asm"]["J"]).apply(null, arguments); };
        var _archive_entry_filetype = Module["_archive_entry_filetype"] = function () { return (_archive_entry_filetype = Module["_archive_entry_filetype"] = Module["asm"]["K"]).apply(null, arguments); };
        var _archive_entry_hardlink_utf8 = Module["_archive_entry_hardlink_utf8"] = function () { return (_archive_entry_hardlink_utf8 = Module["_archive_entry_hardlink_utf8"] = Module["asm"]["L"]).apply(null, arguments); };
        var _archive_entry_mtime = Module["_archive_entry_mtime"] = function () { return (_archive_entry_mtime = Module["_archive_entry_mtime"] = Module["asm"]["M"]).apply(null, arguments); };
        var _archive_entry_pathname_utf8 = Module["_archive_entry_pathname_utf8"] = function () { return (_archive_entry_pathname_utf8 = Module["_archive_entry_pathname_utf8"] = Module["asm"]["N"]).apply(null, arguments); };
        var _archive_entry_size = Module["_archive_entry_size"] = function () { return (_archive_entry_size = Module["_archive_entry_size"] = Module["asm"]["O"]).apply(null, arguments); };
        var _archive_entry_symlink_utf8 = Module["_archive_entry_symlink_utf8"] = function () { return (_archive_entry_symlink_utf8 = Module["_archive_entry_symlink_utf8"] = Module["asm"]["P"]).apply(null, arguments); };
        var _archive_entry_is_encrypted = Module["_archive_entry_is_encrypted"] = function () { return (_archive_entry_is_encrypted = Module["_archive_entry_is_encrypted"] = Module["asm"]["Q"]).apply(null, arguments); };
        var _free = Module["_free"] = function () { return (_free = Module["_free"] = Module["asm"]["R"]).apply(null, arguments); };
        var ___errno_location = function () { return (___errno_location = Module["asm"]["S"]).apply(null, arguments); };
        var _malloc = Module["_malloc"] = function () { return (_malloc = Module["_malloc"] = Module["asm"]["T"]).apply(null, arguments); };
        var _archive_read_has_encrypted_entries = Module["_archive_read_has_encrypted_entries"] = function () { return (_archive_read_has_encrypted_entries = Module["_archive_read_has_encrypted_entries"] = Module["asm"]["U"]).apply(null, arguments); };
        var _archive_read_data = Module["_archive_read_data"] = function () { return (_archive_read_data = Module["_archive_read_data"] = Module["asm"]["V"]).apply(null, arguments); };
        var _archive_read_data_skip = Module["_archive_read_data_skip"] = function () { return (_archive_read_data_skip = Module["_archive_read_data_skip"] = Module["asm"]["W"]).apply(null, arguments); };
        var _archive_version_number = Module["_archive_version_number"] = function () { return (_archive_version_number = Module["_archive_version_number"] = Module["asm"]["X"]).apply(null, arguments); };
        var _archive_version_string = Module["_archive_version_string"] = function () { return (_archive_version_string = Module["_archive_version_string"] = Module["asm"]["Y"]).apply(null, arguments); };
        var _archive_error_string = Module["_archive_error_string"] = function () { return (_archive_error_string = Module["_archive_error_string"] = Module["asm"]["Z"]).apply(null, arguments); };
        var _archive_version_details = Module["_archive_version_details"] = function () { return (_archive_version_details = Module["_archive_version_details"] = Module["asm"]["_"]).apply(null, arguments); };
        var _archive_read_free = Module["_archive_read_free"] = function () { return (_archive_read_free = Module["_archive_read_free"] = Module["asm"]["$"]).apply(null, arguments); };
        var setTempRet0 = function () { return (setTempRet0 = Module["asm"]["aa"]).apply(null, arguments); };
        var stackSave = function () { return (stackSave = Module["asm"]["ba"]).apply(null, arguments); };
        var stackRestore = function () { return (stackRestore = Module["asm"]["ca"]).apply(null, arguments); };
        var stackAlloc = function () { return (stackAlloc = Module["asm"]["da"]).apply(null, arguments); };
        Module["cwrap"] = cwrap;
        var calledRun;
